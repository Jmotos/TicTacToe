sap.ui.define([
	...
	"sap/ui/model/json/JSONModel", "../model/Game",
	"../model/Repository"
], function (Controller, UIComponent, History, JSONModel, Game, Repository) {
	"use strict";
	...
	return Controller.extend("com.trifork.tictactoe.controller.BaseController", {
		...
		initializeNewGame: function() {
			...
			this.setGameModel(game);
			return game;
		},

		setGameModel: function(game) {
